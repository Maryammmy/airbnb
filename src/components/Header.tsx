    ...
    <header className="border-b">
      <div className="px-5 xl:px-20 m-auto  flex justify-between items-center py-5">
        ...
        <div className=" hidden xl:flex items-center gap-2">
          <div className="font-semibold py-2 px-4 rounded-full hover:bg-[#F7F7F7]">
            <h3>Airbnb your home</h3>
          </div>
          <div className="py-2 px-4 rounded-full hover:bg-[#F7F7F7]">
            <Globe size={18} />
          </div>
          <div className="flex items-center border py-2 px-3 rounded-full gap-1 hover:shadow-lg">
            <div>
              <Menu size={18} />
            </div>
            <div>
